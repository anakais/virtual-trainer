        ...
        >
          <div class="mb-6 flex items-center justify-between">
            <div class="flex items-center space-x-4">
              <div
                class="flex h-16 w-16 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-500 to-teal-600"
              >
          ...
          <!-- Exercise Tips -->
          <div class="mt-6 rounded-lg bg-emerald-50 p-4 dark:bg-emerald-900/30">
            <p

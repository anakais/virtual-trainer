      ...
      <div class="max-w-4xl mx-auto space-y-8">
        ...
        >
          ...
          <div class="mt-6 p-4 bg-emerald-50 dark:bg-emerald-900/30 rounded-2xl">
            <p class="text-emerald-800 dark:text-emerald-200 text-sm flex items-start">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-sm border border-gray-100 dark:border-gray-700">
          ...
          <div class="bg-gray-100 dark:bg-gray-600 rounded-full h-3 mb-4">
            <div 
              class="bg-gradient-to-r from-emerald-500 to-teal-600 h-3 rounded-full transition-all duration-300"
